...
var loadPlaces = function loadPlaces(map) {
  ...
  _axios2.default.get("/api/store/near?lat=" + lat + "&lng=" + lng).then(function (res) {
    var places = res.data;
...
exports.default = function (mapDiv) {
  if (!mapDiv) return;

  var map = new google.maps.Map(mapDiv, mapOptions);
  var input = (0, _bling.$)(".autocomplete__input[name='geolocate']");
